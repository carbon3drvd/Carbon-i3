...
module y_motor_holes(){
 ...
 //endstop
    ...
    translate([18,45,15.5]) rotate([90,0,0]) cylinder(h = 10, r=1.2, $fn=20);
    translate([18,42.2,15.5]) rotate([90,0,0]) cylinder(h = 2, r1=1.2, r2=0.8, $fn=20);
 
    translate([18,45,25.0]) rotate([90,0,0]) cylinder(h = 10, r=1.2, $fn=20);
    translate([18,42.2,25.0]) rotate([90,0,0]) cylinder(h = 2, r1=1.2, r2=0.8, $fn=20);
