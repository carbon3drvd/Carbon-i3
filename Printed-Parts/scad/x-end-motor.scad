...
raio_furos_motor = 2.0;
raio_furos_chave_fim_curso = 1.3;
...
module x_end_motor_endstop_holes(){
    translate([-23.5,-28.5,58]){
        translate([17/2,7.5,-5]){ // Bruno
            // Back screw hole for endstop
            //translate([-4.75,0,0])cylinder(r=1,h=19,$fn=20);
            translate([-4.75,0,0])cylinder(r=raio_furos_chave_fim_curso,h=19,$fn=20); // Bruno
...
module x_end_motor_holes(){
 ...
 translate(v=[-1,32,30.25]){
  ...
  //translate(v=[20,-15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=1.8, $fn=30);
     translate(v=[20,-15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=raio_furos_motor, $fn=30); // Bruno
  translate(v=[3,-15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10, r=3.1, $fn=30); // Bruno
  //translate(v=[20,-15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=1.8, $fn=30);
    translate(v=[20,-15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=raio_furos_motor, $fn=30);
  translate(v=[3,-15.5,15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10, r=3.1, $fn=30); // Bruno
   //translate(v=[20,15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=1.8, $fn=30);
   translate(v=[20,15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 70, r=raio_furos_motor, $fn=30);
  translate(v=[3,15.5,-15.5]) rotate(a=[0,-90,0]) rotate(a=[0,0,90]) cylinder(h = 10, r=3.1, $fn=30); // Bruno
