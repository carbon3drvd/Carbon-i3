...
module x_end_idler_holes(){
    ...
    translate(v=[1.5,-22,30.25]) rotate(a=[0,-90,0]) cylinder(h = 10, r=3.1, $fn=30); // Bruno
    translate(v=[-21.5,-22,30.25]) rotate(a=[0,-90,0]) rotate(a=[0,0,0]) cylinder(h = 80, r=3.3, $fn=6); // Bruno
